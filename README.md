...
| `group-collect`       | Groups rows as array and do math operations at the same time in a row.             | `group-by`, `to-array-column`, `to-array-output-column`, `do-maths-column`, `do-maths-operation` | —                                    |
